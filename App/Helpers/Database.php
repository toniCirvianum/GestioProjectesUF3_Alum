...
class Database
{
    ...
    //$sql es la sentencial sql 
    //$params son els parametres que li passem a la sentencia, es fa així epr eviatr sql injection
    //$id es un booleà que indica si volem que ens retorni l'id de l'ultim item inserit
    {
